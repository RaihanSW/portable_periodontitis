...
# loaded_model.load_weights("drive/MyDrive/Trained_weight/model_unet_lower_teeth_2023_augment.h5")
loaded_model.load_weights("drive/MyDrive/Trained_weight/model_unet_lower_teeth_100_rsgm.h5")
...
loc_file = 'drive/MyDrive/Data_lama_raihan/' + '3_bottom_prob_' + image_name[:-4] +'.png'
imsave(loc_file, new_image)

# plt.figure(3)
# plt.imshow(np.uint8(newmask))
# plt.show()
# loc_file = './' + 'bottom_teeth_' + image_name
